...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_branches, num_classes=10, zero_init_residual=False, groups=1, 
        ...
        self.en_fc = nn.Linear(fc.in_features * self.num_branches, num_classes)
...
def resnet32_pcl(**kwargs): 
    model = ResNet(BasicBlock, [5, 5, 5], **kwargs)
    return model

def resnet110_pcl(**kwargs):
    model = ResNet(Bottleneck, [12, 12, 12], **kwargs)
    return model

def wide_resnet20_8_pcl(**kwargs):
