...
class DenseNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x1 = self.classifier1(x_f)
        x2 = self.classifier1(x_f)
        return x1, x2
        if self.KD == True:
            return x_f, x
        else:
...
def densenetd40k12_ema(pretrained=False, path=None, **kwargs):
    """
...
def densenetd100k12_ema(pretrained=False, path=None, **kwargs):
    """
...
def densenetd190k12_ema(pretrained=False, path=None, **kwargs):
    """
...
def densenetd100k40_ema(pretrained=False, path=None, **kwargs):
    """
