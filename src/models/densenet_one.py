...
def densenetd40k12_one(pretrained=False, path=None, **kwargs):
    """
...
def densenetd100k12_one(pretrained=False, path=None, **kwargs):
    """
...
def densenetd100k40_one(pretrained=False, path=None, **kwargs):
    """
