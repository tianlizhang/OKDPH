...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x1 = self.fc1(x_f)                # B x num_classes
        x2 = self.fc2(x_f)                # B x num_classes
        
        return x1, x2

   
def resnet32_ema(pretrained=False, path=None, **kwargs):
    """
...
def resnet110_ema(pretrained=False, path=None, **kwargs):
    """
...
def wide_resnet20_8_ema(pretrained=False, path=None, **kwargs):
