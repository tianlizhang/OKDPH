...
def resnet32_okddip(pretrained=False, path=None, **kwargs):
    """
...
def resnet110_okddip(pretrained=False, path=None, **kwargs):
    """
...
def wide_resnet20_8_okddip(pretrained=False, progress=True, **kwargs):
