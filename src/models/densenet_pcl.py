...
class DenseNet(nn.Module):
    ...
    """
    def __init__(self, num_branches, growth_rate=12, block_config=[16, 16, 16], compression=0.5,
        ...
        self.branch0 = Branch(block, fc, self.avgpool_size)
...
def densenetd40k12_pcl(pretrained=False, path=None, **kwargs):
    """
...
def densenetd100k12_pcl(pretrained=False, path=None, **kwargs):
    """
...
def densenetd190k12_pcl(pretrained=False, path=None, **kwargs):
    """
...
def densenetd100k40_pcl(pretrained=False, path=None, **kwargs):
    """
